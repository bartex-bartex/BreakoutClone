...
class Ball:
    ...
    def update(self, sprite: Sprite, tiles: List[List[Tile]],  map_width, map_height, game) -> bool:
        ...
        elif is_collision(next_x, next_y, Rectangle(sprite.x, sprite.y, sprite.length, 1)):  # check - sprite collision
